...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smart-mode-line counsel-projectile rainbow-delimiters color-theme-sanityinc-tomorrow org org-bullets ivy swiper evil evil-leader smartparens exec-path-from-shell popwin hungry-delete google-translate avy window-numbering company magit evil-magit flycheck go-mode go-eldoc company-go))))
(custom-set-faces
