...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm evil-magit magit evil-leader ace-window avy company-go go-eldoc go-mode powerline solarized-theme hungry-delete popwin exec-path-from-shell smartparens evil org org-bullets company use-package))))
(custom-set-faces
