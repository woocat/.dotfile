...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (color-theme-sanityinc-tomorrow org org-bullets ivy swiper evil evil-leader smartparens exec-path-from-shell popwin hungry-delete google-translate avy window-numbering company magit evil-magit flycheck go-mode go-eldoc company-go rainbow-delimiters counsel-projectile smart-mode-line))))
(custom-set-faces
